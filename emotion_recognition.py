...
# Decision Tree
emotions_dataset = pd.read_csv(
    'dataset/normalizedData-collectedData-sorted.csv')
print(
...
prediction = clf.predict([
    ...
    [0.9475984379, 1, 0.058230485348, 0.999,
        0.223341, 0.57634, 0.1111, 0.8654, 0, 0.24],
    [0, 1, 0, 0, 0, 0, 0.9999, 0.4543, 1, 0.23423],
    [0.3645645, 0.2223, 0.34323, 0.235521, 0.2452134,
        0.256542, 0.45616, 0.49765, 0.4162, 0.6007],
])
